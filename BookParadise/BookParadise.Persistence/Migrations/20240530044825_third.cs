    ...
    public partial class third : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "06174e31-398c-4537-9e9b-c72275c05261", "Brandon Sanderson", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1658), "Ash falls from the sky in the empire of Luthadel, where a ruthless Lord Ruler has brooded for a thousand years. Vin, a young woman living a life of hardship, discovers her hidden power and joins a rebellion to overthrow the empire.", "978-0765360946", new DateTime(2006, 4, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tor Books", 80, "Mistborn: The Final Empire", 672, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1658) },
                    { "10044292-409e-4f56-a08c-f6d6818202dd", "Douglas Adams", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1717), "Seconds before Earth is demolished to make way for a galactic freeway, Arthur Dent is plucked off the planet by his friend Ford Prefect, a researcher for the revised edition of The Hitchhiker's Guide to the Galaxy.", "978-0345391803", new DateTime(1979, 10, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Del Rey Books", 85, "The Hitchhiker's Guide to the Galaxy", 216, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1718) },
                    { "2046273a-28a9-4c86-989e-e8503ab15855", "Alexandre Dumas", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1784), "After being wrongfully imprisoned for years, Edmond Dantès escapes and reinvents himself as the wealthy Count of Monte Cristo, determined to seek revenge against those who conspired against him.", "978-0140449264", new DateTime(1844, 8, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Penguin Classics", 60, "The Count of Monte Cristo", 1312, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1784) },
                    { "2baa7253-71f0-4496-9a41-073196d8b36f", "Milan Kundera", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1763), "Set in Prague during the 1968 Soviet invasion, the novel explores the lives of two couples and their complex relationships, intertwined with philosophical musings on love, life, and the human condition.", "978-0060932139", new DateTime(1984, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Harper Perennial", 45, "The Unbearable Lightness of Being", 320, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1764) },
                    { "2be26027-44da-4083-a665-3a44015fc243", "J.R.R. Tolkien", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1732), "J.R.R. Tolkien's epic high-fantasy novel that chronicles the quest to destroy the One Ring and defeat the Dark Lord Sauron. A timeless tale of courage, friendship, and the struggle between good and evil.", "978-0618640157", new DateTime(1954, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Houghton Mifflin Harcourt", 65, "The Lord of the Rings", 1216, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1732) },
                    { "35fbacfe-11cd-44fd-8ea5-1a9ede60698d", "Frank Herbert", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1710), "Set in a distant future where the universe is ruled by noble families, Dune tells the epic story of Paul Atreides, whose family accepts control of the desert planet Arrakis, the only source of the valuable spice melange.", "978-0441013593", new DateTime(1965, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ace Books", 75, "Dune", 896, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1710) },
                    { "4dd70b8f-9d21-4934-a235-7500a843205c", "Oscar Wilde", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1757), "Dorian Gray, a young and handsome man, becomes obsessed with his own beauty and makes a fateful wish to remain youthful forever. As he indulges in a life of pleasure and sin, his portrait begins to age and reflect his corrupted soul.", "978-0486278070", new DateTime(1890, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dover Publications", 55, "The Picture of Dorian Gray", 256, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1757) },
                    { "4e565800-f65c-4a0a-858a-6330c94e0d3d", "Stephen King", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1777), "Jack Torrance, his wife, and their young son become the winter caretakers of the isolated Overlook Hotel. However, they soon discover the hotel's haunted past and Jack's own demons threaten to destroy them all.", "978-0385121675", new DateTime(1977, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Doubleday", 70, "The Shining", 447, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1777) },
                    { "4f220773-cb31-4c05-ad48-fab1bf2fb459", "Khaled Hosseini", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1770), "Khaled Hosseini's powerful novel about the bond between two boys in Afghanistan and the path of redemption. A gripping tale of friendship, betrayal, and the power of atonement.", "978-1594480003", new DateTime(2003, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Riverhead Books", 65, "The Kite Runner", 368, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1771) },
                    { "539cc5aa-80e9-4990-be6b-4818744942a2", "Andy Weir", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1703), "After a mission gone wrong, astronaut Mark Watney finds himself stranded alone on Mars with limited supplies. He must utilize his ingenuity and determination to survive in the harsh environment while NASA tries to bring him home.", "978-0553418026", new DateTime(2014, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Crown Publishing Group", 60, "The Martian", 384, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1703) },
                    { "75007318-96cb-4f83-807d-9df6cfc898b4", "Vernor Vinge", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1688), "In a universe divided by a vast barrier of faster-than-light travel, humanity finds itself on the losing side of a war with a technologically superior alien race. A young starship captain stumbles upon a hidden cache of ancient technology that could turn the tide.", "978-0345380977", new DateTime(1992, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Baen Books", 70, "A Fire Upon the Deep", 624, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1688) },
                    { "7766aa58-173e-4491-a2fb-5d4656be8155", "Lois Lowry", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1750), "Jonas lives in a seemingly utopian society where all memories of the past are held by a single person called the Receiver. When Jonas is selected as the next Receiver, he uncovers the dark truth behind his community's perfect facade.", "978-0544336261", new DateTime(1993, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Houghton Mifflin Harcourt", 90, "The Giver", 179, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1751) },
                    { "815e3405-d107-421f-a88e-0128522ed159", "Andy Weir", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1666), "Ryland Grace wakes up disoriented on a spaceship with no memory of his past. As he pieces together his fragmented memories, he discovers he is on a one-way mission to a distant star system carrying a desperate hope for humanity.", "978-0593338491", new DateTime(2021, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ballantine Books", 50, "Project Hail Mary", 464, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1666) },
                    { "9fb935a0-b432-44cf-92b0-19f5528fdd99", "Margaret Atwood", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1739), "In a dystopian future, a woman is forced to live as a concubine under a fundamentalist theocratic dictatorship. The novel explores themes of subjugation, resistance, and the resilience of the human spirit.", "978-0385490818", new DateTime(1985, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Anchor Books", 80, "The Handmaid's Tale", 311, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1739) },
                    { "a6f47ed2-a44b-47df-900d-7b3388769e8b", "Fyodor Dostoevsky", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1895), "Fyodor Dostoevsky's final novel explores the moral dilemmas and spiritual conflicts within a dysfunctional family, delving into themes of faith, reason, and the human psyche.", "978-0140444421", new DateTime(1880, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Penguin Classics", 55, "The Brothers Karamazov", 824, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1896) },
                    { "aa03f8bf-c1af-4cdb-ba56-0a727ecbbd2e", "Orson Scott Card", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1725), "In a future where Earth is under attack by an insectoid alien race, young Andrew 'Ender' Wiggin is recruited to join the elite Battle School, where he must undergo rigorous training to lead humanity's fight for survival.", "978-0812550702", new DateTime(1985, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tor Books", 70, "Ender's Game", 324, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1726) },
                    { "cbd8653d-e07d-4201-8154-ee799ad86b5d", "Agatha Christie", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1695), "A luxurious train journey across Europe is disrupted by a murder.  Hercule Poirot, a renowned detective, must use his keen intellect to identify the killer among a group of suspicious passengers.", "978-0061122731", new DateTime(1934, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "HarperCollins", 90, "Murder on the Orient Express", 320, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1696) },
                    { "e22ca014-f105-45e5-94d4-aa9730bc12d6", "Patrick Rothfuss", "Content", new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1643), "In a world shrouded in mystery, a young orphan named Kvothe enters a prestigious academy for magic users. There, he learns the mystical arts, confronts deadly enemies, and unravels an ancient secret.", "978-0765364560", new DateTime(2007, 6, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "DAW Books", 100, "The Name of the Wind", 624, new DateTime(2024, 5, 30, 4, 48, 25, 179, DateTimeKind.Utc).AddTicks(1644) }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "06174e31-398c-4537-9e9b-c72275c05261");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "10044292-409e-4f56-a08c-f6d6818202dd");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "2046273a-28a9-4c86-989e-e8503ab15855");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "2baa7253-71f0-4496-9a41-073196d8b36f");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "2be26027-44da-4083-a665-3a44015fc243");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "35fbacfe-11cd-44fd-8ea5-1a9ede60698d");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "4dd70b8f-9d21-4934-a235-7500a843205c");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "4e565800-f65c-4a0a-858a-6330c94e0d3d");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "4f220773-cb31-4c05-ad48-fab1bf2fb459");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "539cc5aa-80e9-4990-be6b-4818744942a2");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "75007318-96cb-4f83-807d-9df6cfc898b4");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "7766aa58-173e-4491-a2fb-5d4656be8155");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "815e3405-d107-421f-a88e-0128522ed159");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "9fb935a0-b432-44cf-92b0-19f5528fdd99");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "a6f47ed2-a44b-47df-900d-7b3388769e8b");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "aa03f8bf-c1af-4cdb-ba56-0a727ecbbd2e");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "cbd8653d-e07d-4201-8154-ee799ad86b5d");

            migrationBuilder.DeleteData(
                table: "Books",
                keyColumn: "Id",
                keyValue: "e22ca014-f105-45e5-94d4-aa9730bc12d6");
